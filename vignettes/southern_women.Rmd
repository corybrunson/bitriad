...
```{r}
(exclWedges <- excl_transitivity(women_clique, type = ""))
```
...
C_local_dat <- cbind(
    C = C_local,
    OpsahlC = opsahl_transitivity(women_clique, type = "local"),
    exclC = excl_transitivity(women_clique, type = "local")
)
...
```{r, fig.height = 5}
women_group_wedges <- opsahl_transitivity(women_group, type = "")
...
```{r, fig.height = 5}
women_group_wedges <- excl_transitivity(women_group, type = "")
women_group_wedges <- cbind(
    women_group_wedges,
