...
[^2]: The calculations are wrapped into `triad_closure_from_census()`, which can also handle uniformity, structural, and simple census input, provided the desired measure of transitivity can be recovered therefrom.
