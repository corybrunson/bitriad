...
```{r}
(exclWedges <- triadclosure_exclusive(women_clique, type = "raw"))
```
...
C_local_dat <- cbind(
    C = C_local,
    OpsahlC = triadclosure_opsahl(women_clique, type = "local"),
    exclC = triadclosure_exclusive(women_clique, type = "local")
)
...
```{r, fig.height = 5}
women_group_wedges <- triadclosure_opsahl(women_group, type = "raw")
...
```{r, fig.height = 5}
women_group_wedges <- triadclosure_exclusive(women_group, type = "raw")
women_group_wedges <- cbind(
    women_group_wedges,
