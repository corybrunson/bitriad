...
[^2]: The calculations are wrapped into `triad_closure_from_census()`, which can also handle difference, binary, and simple census input, provided the desired measure of triad closure can be recovered therefrom.
...
There is also a clear trade-off between the number of a woman's acquaintances and the proportion of them that are also acquainted.
