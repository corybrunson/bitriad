...
#'   \item The *full triad census* (Brunson, 2015) records the number of 
...
#'   partitions \eqn{\lambda} ordered according to the *revolving door 
...
#'   [triad_census_difference], is organized into a \eqn{8\times 2} 
...
#'   \item The *simple triad census* is the 4-entry triad census on a 
