...
// 
Rcpp::List invert_map(nbhd_order_map_jcb m) {
...
std::set<int> get_alters_for(int ae, Rcpp::IntegerMatrix el, std::set<int> s) {
  std::set<int> res;
...
nbhd_order_map_jcb node_nbhd(
    const int order, int ae, Rcpp::IntegerMatrix el, int q
) {
