...
dynamic_wedges_x0w0m20c02 <- function(el, t, q, memory, wedge_gap, close_after, close_by) {
    .Call('_bitriad_dynamic_wedges_x0w0m20c02', PACKAGE = 'bitriad', el, t, q, memory, wedge_gap, close_after, close_by)
}
