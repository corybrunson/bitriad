#' Two-mode clustering coefficients
#' (injective morphisms modulo structural equivalence)
#' 
...
#' twomode.transitivity, calls one of the wedge functions and computes the
...
function(
    ...
    twomode.transitivity(
        ...
        wedges.fn = injseq.wedges, vids = vids)
}
