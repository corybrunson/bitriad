...
#' 
#' @param wedges A two-column matrix of wedge and closed wedge counts centered at each of some collection of nodes.
#' @param type Character; the type of clustering coefficient (defaults to
#' "global").
#' @return A transitivity statistic of type \code{type} calculated from the wedges \code{wedges}, in a format that can be fed into \code{sapply}.
